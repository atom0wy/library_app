...
class ExampleDataLoader {
    ...
    public void onApplicationLoad(ApplicationReadyEvent event) {
        ...
        Book book = new Book("Midnight", "Joe", "1990", "Horror", BookStatus.IN_STOCK, user);
        Book book1 = new Book("Daylight", "Jack", "2000", "Comedy", BookStatus.IN_STOCK, user1);
        Book book2 = new Book("Dusk", "Jeff", "2005", "Fantasy", BookStatus.IN_STOCK, user);
        Book book3 = new Book("Dawn", "Joel", "2001", "Historical", BookStatus.IN_STOCK, user);
        Book book4 = new Book("Sorrow", "Marry", "1980", "Horror", BookStatus.IN_STOCK, user1);
